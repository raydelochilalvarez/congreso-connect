...
function UserCard({ user, onLogout }: { user: AuthUser; onLogout: () => void }) {
  return (
    <div className="space-y-3">
      ...
      <button
        onClick={onLogout}
        className="w-full rounded-full border border-border px-3 py-1.5 text-xs font-semibold text-foreground/80 transition hover:bg-muted"
      >
        Cerrar sesión
      </button>
    </div>
              ...
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-full border border-border px-3 py-1.5 text-xs font-semibold text-foreground/80"
                  >
                    Salir
                  </button>
                </div>
